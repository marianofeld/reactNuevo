                ...
                <div>
                    ...
                    <div className="flex items-center py-5">
                        ...
                        <button
                            ...
                            disabled={cantidad >= arma.stock}
                            className={`bg-gray-800 text-3xl hover:bg-gray-700 text-white font-bold py-2 px-4 border-b-4 border-gray-600 hover:border-gray-500 rounded ${cantidad >= arma.stock ? 'hidden' : 'block'}`}
                        >+</button>
                    </div>
